...
export const addExperience = (formData, history) => async (dispatch) => {
  try {
    ...
    //We're making a post request to api/profile which allows you to update experience
...
export const addEducation = (formData, history) => async (dispatch) => {
  try {
    ...
    //We're making a post request to api/profile which allows you to update education
